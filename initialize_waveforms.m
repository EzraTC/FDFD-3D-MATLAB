...
% Stash into 'waveforms' %Moved to define_sources and lumped elements
waveforms.plane_wave.theta_inc = theta_inc;
waveforms.plane_wave.phi_inc   = phi_inc;
waveforms.plane_wave.k0        = k0;
waveforms.plane_wave.E_theta   = E_theta;
waveforms.plane_wave.E_phi     = E_phi;
waveforms.plane_wave.khat      = [kx_hat, ky_hat, kz_hat];
waveforms.plane_wave.E_center  = E_inc_center;
waveforms.plane_wave.H_center  = H_inc_center;
% =========================================================================
